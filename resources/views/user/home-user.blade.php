    ...
    <main class="justify-content-center">
        ...
        <section class="container" style="margin-top: 50px;">
            <div class="mb-3">
                ...
                <p class="text-gray-600">
                    Temukan motor sesuai tipe, merk, status, dan budget Anda.
                </p>
            </div>
            <div class="d-lg-none mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold fs-5 mb-0">Filter kendaraan</h5>
                    <button class="btn btn-primary py-1 px-3 d-flex align-items-center gap-1" type="button" data-bs-toggle="collapse" data-bs-target="#homeFilter">
                        Edit filter
                        <i class="bi bi-chevron-down"></i>
                    </button>
                </div>
            </div>
            <div class="collapse d-lg-block" id="homeFilter">
                <form method="GET" action="{{ route('vehicles-list.index') }}" id="homeFilterForm" class="col-12 bg-light p-4 rounded-4 shadow-sm">
        ...
        <section class="container" style="margin-top: 50px;">
            ...
            <div class="mb-3 mb-md-5">
                ...
                <p class="text-gray-600">
                    Pilih kendaraan yang paling sesuai dengan gaya perjalanan dan budget Anda. Semua motor terawat, siap
                    jalan!
                </p>
            </div>
            <!-- Vehicle List -->
            ...
            <div class="d-flex d-md-none justify-content-center mt-4">
                <a href="{{ route('vehicles-list.index') }}" class="btn btn-outline-primary px-5">Lihat semua</a>
            </div>
        </section>
