            ...
            <div class="mx-3 mx-md-0">
                ...
                <div class="d-lg-none mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-link text-decoration-none p-0 d-flex align-items-center gap-1" type="button"
                ...
                <div class="collapse d-lg-block" id="mobileFilter">
                    <form method="GET" action="{{ route('vehicles-list.index') }}" id="filterForm"
                        class="col-12 mb-4 bg-light p-4 rounded-4 shadow-sm">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control"
                                        placeholder="Cari nama motor..." value="{{ request('search') }}"
