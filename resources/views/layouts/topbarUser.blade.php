    ...
    <nav class="navbar navbar-expand-lg py-3">
        <div class="container">
            ...
            <a href="{{ route('home.user') }}" class="navbar-brand d-flex align-items-center">
                <img src="{{ asset('img/logo/horizontal.svg') }}" alt="Logo" class="img-fluid"
            ...
            <div class="collapse navbar-collapse d-none d-lg-flex">
                <ul class="navbar-nav ms-auto align-items-center gap-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('booking.history') ? 'active text-primary fw-semibold' : '' }}"
                            href="{{ route('booking.history') }}">Daftar Pesanan</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="offcanvas offcanvas-end d-lg-none" tabindex="-1" id="mobileNavbar">
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link py-3 border-bottom {{ request()->routeIs('home.user') ? 'active text-primary fw-semibold' : '' }}"
                                href="{{ route('home.user') }}">
                                Home
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-3 border-bottom {{ request()->routeIs('vehicles-list.index') ? 'active text-primary fw-semibold' : '' }}"
                                href="{{ route('vehicles-list.index') }}">
                                Pilih Kendaraan
                            </a>
                        </li>
